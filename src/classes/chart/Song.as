package classes.chart
{
    ...
    public class Song extends EventDispatcher
    {
            ...
            if (type == NoteChart.FFR_MP3)
            {
                ...
                { // && !this.entry.engine) {
                    ...
                    else if (chartData.length == 3)
                    {
                        ...
                        if (code == "403")
                        {
                            Logger.info(this, "Using Cached File");
        ...
        private function musicLoadError(e:ErrorEvent = null):void
        {
            Logger.error(this, "Music Load Error: " + Logger.event_error(e));
            isMusicLoaderLoading = false;
        ...
        private function chartLoadError(e:ErrorEvent = null):void
        {
            Logger.error(this, "Chart Load Error: " + Logger.event_error(e));
